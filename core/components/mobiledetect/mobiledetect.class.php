...
class MobileDetect {
	...
	function __construct(modX &$modx, array $config = array()) {
		...
		$corePath = $this->modx->getOption('mobiledetect_core_path', $config, $this->modx->getOption('core_path') . 'components/mobiledetect/');
		$this->config = array_merge(array(
			...
			'session_cookie_path' => $this->modx->getOption('session_cookie_path', null, $this->modx->getOption('base_url', null, MODX_BASE_URL), true),
	...
	public function getDetector() {
		if (!class_exists('Mobile_Detect')) {
			require $this->config['corePath'] . 'Mobile-Detect/Mobile_Detect.php';
		}
	...
	public function getSettings() {
		if (!empty($_COOKIE[$this->config['force_browser_variable']])) {
